...
namespace Household.Budget.Unit.Tests.Fixtures.Fakers.MonthlyBudgets
{
    public class CreateMonthlyBudgetRequestFaker : CreateMonthlyBudgetRequest
    {
        ...
        public CreateMonthlyBudgetRequest WithCategoryInvalidPlannedTottal()
        {
        ...
        public CreateMonthlyBudgetRequest WithNonExistentCategory()
        {
            //TODO: add categoria inexistente
            return this;
        }

        public CreateMonthlyBudgetRequest WithNonExistentSubcategory()
        {

            //TODO: add subcategoria inexistente
            return this;
        }
