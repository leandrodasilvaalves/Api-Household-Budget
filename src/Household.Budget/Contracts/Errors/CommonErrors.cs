...
namespace Household.Budget.Contracts.Errors
{
    public static class CommonErrors
    {
        ...
        public static Notification INVALID_YEAR => new("INVALID_YEAR", $"The year must be between the current year minus {CurrentYear.Min} and the current year plus {CurrentYear.Max}.");
