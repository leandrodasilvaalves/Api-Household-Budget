...
public class TransactionErrors
{
    ...
    public static Notification TRANSACTION_DATE_INVALID_YEAR = new("TRANSACTION_DATE_INVALID_YEAR", $"The transaction date year must be between the current year minus {Year.Min} and the current year plus {Year.Max}.");
